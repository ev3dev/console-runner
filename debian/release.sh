...
OS=debian DIST=${distribution} ARCH=i386 PBUILDER_OPTIONS="--binary-arch" pbuilder-ev3dev build
...
debsign ~/pbuilder-ev3dev/debian/${distribution}-i386/${source}_${version}_i386.changes
...
dput ev3dev-debian ~/pbuilder-ev3dev/debian/${distribution}-i386/${source}_${version}_i386.changes
